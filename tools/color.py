import cv2
import numpy as np
from img_processing import expose_blue, expose_red, expose_yellow_and_orange, expose_yellow, expose_orange, preprocess_binary_img, preprocess_image
...
while True:
    ...
    orange = expose_orange(img)
    yellow = expose_yellow(img)
 
    imgStack = stackImages(0.6,([img,imgHSV],[expose_red(img), bin_for_color(expose_red(img), 700)]))
